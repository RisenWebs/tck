...
export async function getServerSideProps() {
	const response = await axios.get(
		`https://kick.com/api/v2/channels/${CHANNEL}/livestream`,
		{
			headers: {
			...
			<div className={classes.sectionWrapper}>
				<div className={clsx(classes.section, classes.hero)}>
					...
					<div className={classes.heroTop}>
						...
						<p className={classes.description}>
							Elevate Your Game: The Ultimate Destination for Rewarding Players
							and Viewers <br /> for being a part of the TCK Community.
						</p>
					</div>
				...
				<div className={classes.gfuelWrapper}>
					<Image
						src={gfuelBackground}
						alt="Background "
						className={classes.gfuelBackground}
					/>
				...
				{isLive && (
					<div className={classes.section}>
						...
						<div className={classes.sectionHeader}>
							<p className={classes.kickSectionDescription}>
								I AM LIVE ON KICK
							</p>
						...
						>
							...
							<div
								style={{
									...
									bottom: "-73px",
									background:
										"linear-gradient(90deg, #DDB43F 0%, #9B7C25 100%)",
									filter: "blur(150px)",
								}}
							/>
              ...
              />
					...
					<div
						className={clsx(
							classes.affiliateWrapper,
							classes.fadedAffiliateWrapper,
						)}
					>
